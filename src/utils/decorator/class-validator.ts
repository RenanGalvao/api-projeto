...
export const IsNumber = (numberOptions?: IsNumberOptions, options?: ValidationOptions) =>
  _IsNumber(
    { ...numberOptions },
    {
      ...options,
...
export const IsPhoneNumber = (region?: CountryCode, options?: ValidationOptions) =>
...
export const IsUrl = (urlOptions?: ValidatorJS.IsURLOptions, options?: ValidationOptions) =>
  _IsUrl(
    { ...urlOptions },
    {
      ...options,
...
export const IsNotEmptyObject = (options?: Nullable, validationOptions?: ValidationOptions) =>
  _IsNotEmptyObject(
    { ...options },
    {
      ...validationOptions,
...
export const IsUUID = (version?: UUIDVersion, options?: ValidationOptions) => _IsUUID(version, {
  ...options,
