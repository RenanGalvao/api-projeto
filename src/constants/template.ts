export class TEMPLATE {
  static ROUTES = {
    CREATE: (route: string, gender: string) =>
      `${route} criad${gender} com sucesso!`,
    FIND_ONE: (route: string, gender: string) =>
      `${route} recuperad${gender} com sucesso!`,
    FIND_ALL: (route: string, gender: string) =>
      `${route} recuperad${gender}s com sucesso!`,
    UPDATE: (route: string, gender: string) =>
      `${route} atualizad${gender} com sucesso!`,
    REMOVE: (route: string, gender: string) =>
      `${route} removid${gender} com sucesso!`,
    BULK_CREATE: (route: string, gender: string) =>
      `${route} criad${gender}s com sucesso!`,
    BULK_REMOVE: (route: string, gender: string) =>
      `${route} removid${gender}s com sucesso!`,
    RESTORE: (route: string, gender: string) =>
      `${route} restaurad${gender}s com sucesso!`,
    CLEAN: (route: string, gender: string) =>
      `${route} zerad${gender}s com sucesso!`,
    HARD_REMOVE: (route: string, gender: string) =>
      `${route} removid${gender}s permanentemente com sucesso!`,
  };
  ...
  static VALIDATION = {
    ...
    IS_DATE_STRING: (prop: string) =>
      `${prop} deve ser uma data válida. Ex.: aaaa-mm-dd.`,
    IS_NUMBER: (prop: string) => `${prop} deve ser um número válido.`,
    IS_NUMBER_STRING: (prop: string) =>
      `${prop} deve ser um número em texto válido.`,
    IS_MILITARY_TIME: (prop: string) =>
      `${prop} deve ser um horário válido. Ex.: HH:MM.`,
    IS_ARRAY: (prop: string) => `${prop} deve ser uma matriz válida.`,
    ARRAY_MAX_SIZE: (prop: string, value: number) =>
      `${prop} deve ser menor ou igual a ${value}.`,
    ARRAY_MIN_SIZE: (prop: string, value: number) =>
      `${prop} deve ser maior ou igual a ${value}.`,
    IS_DECIMAL: (prop: string) =>
      `${prop} deve ser um decimal válido. Ex.: 1.5.`,
    ...
    MIN: (prop: string, value: number) =>
      `${prop} deve ser maior ou igual a ${value}.`,
    MAX: (prop: string, value: number) =>
      `${prop} deve ser menor ou igual a ${value}.`,
    IS_URL: (prop: string) => `${prop} deve ser uma URL válida.`,
    IS_NOT_EMPTY_OBJECT: (prop: string) =>
      `${prop} não pode ser um objeto vazio.`,
    ...
    IS_DATE: (prop: string) => `${prop} deve ser uma data válida.`
  };
  ...
  static EXCEPTION = {
    ...
    FILES_SIZE_EXCEEDS: (maxSize: number) =>
      `O tamanho de um dos arquivos excede o máximo de ${
        maxSize / 1024 / 1024
      } Mb.`,
  };
  ...
  static PIPES = {
    ...
    FILES_TYPE: (fileType: string | RegExp) =>
      `Falha na validação (tipo esperado é ${fileType})`,
  };
}
